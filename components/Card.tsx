...
const Card = () => {
  return (
    <div className='flex flex-col justify-center max-w-xs md:max-w-sm py-5 gap-2'>
        <div className='w-full h-full mb-1'>
            <img src={image.src} className='w-full object-cover rounded-md cursor-pointer'/>
        </div>
        <div className='flex flex-col gap-2'>
            <h1 className='font-bold'>Migrating to Linear 101</h1>
        ...
        <div className='flex items-center gap-2 mt-2'>
            <img src={av.src} className='w-7 h-7 rounded-full object-cover cursor-pointer' />
            <p className='cursor-pointer'>Jonathan Wills</p>
            
            <p className=''>19 Jan 2022</p>
        </div>
    </div>
  )
}
